...
$pdf->Image('../logo/Radish.png',1,1,2,2);
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'Radish Collections',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : 0038XXXXXXX',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'JL. Sidoardjo',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'website : radishcollections.com email : radishcollections@gmail.com',0,'L');
...
$query=mysqli_query($koneksi,"SELECT * from barang_laku where tanggal>='$dari' and tanggal<='$sampai' order by tanggal asc");
